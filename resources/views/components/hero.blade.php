<div class="container hero-container col-12">
    <div class="row align-items-center hero-row">
        ...
        <div class="col-12 col-lg-6 mt-tablet image-column">
            <img src="{{ Route::is('blogs.show', 'skills.show') ? asset($imageSrc) : asset('output/images/' . $imageSrc) }}" class="d-block mx-auto ms-md-auto me-lg-0 img-fluid @if(isset($imageClass)){{ $imageClass }}@endif" alt="{{ $altText }}" width="{{ $width }}" height="{{ $height }}" loading="eager">
        </div>
    </div>
</div>
