<div class="container-fluid fact-container-fluid">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100 fact-card left">
                    ...
                    <div class="card-body mt-4">
                        ...
                        <p class="card-text fact-card-text">{{ $fact1_description }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100 fact-card middle">
                    ...
                    <div class="card-body mt-4">
                        ...
                        <p class="card-text fact-card-text">{{ $fact2_description }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100 fact-card right">
                    ...
                    <div class="card-body mt-4">
                        ...
                        <p class="card-text fact-card-text">{{ $fact3_description }}</p>
                    </div>
                </div>
            </div>
        </div>
