            ...
            <div class="col-12">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-center button-cta-row">
                    <a href="{{ $first_button_url }}"
                       class="btn btn-outline-primary btn-lg px-4 me-md-2 contact-cta-button">{{ $first_button }}</a>

                    @if(!empty($second_button))
                        <a href="{{ $second_button_url }}"
                           class="btn btn-primary btn-lg px-4 align-items-center d-flex read-more-cta-button">{{ $second_button }}</a>
                    @endif
                </div>
            </div>
        </div>
